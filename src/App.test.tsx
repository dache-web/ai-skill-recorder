...
describe('unified review timeline', () => {
  ...
  it('3種類を登録順で並べ動画で確認と前へを使える', async () => {
    ...
    fireEvent.click(screen.getByText('2. ★ポイント')); expect(video.currentTime).toBe(4); fireEvent.click(screen.getByRole('button', { name: '← 前へ' })); expect(video.currentTime).toBe(1)
  })
