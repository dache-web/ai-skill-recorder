...
export const buildAnalysisDocument = (
  ...
  reviewAnnotations: ReviewAnnotations = { maximumPoints: 30, points: [], videoSegments: [], excludedSegments: [], manualTimeline: { status: 'draft', confirmedAt: null, fullReviewCompletedAt: null, overlapAcknowledgedAt: null, items: [], unclassifiedIntervals: [] }, annotations: [], insertedAssets: [], insertedSlides: [] },
